<template>
  <div id="glob-table" >
    <div class="table-wrapping">
      <el-table ref="multipleTable" @sort-change="getCon" :max-height="700" size="medium" show-pagination border :data="dataPagination" style="width: 100%; font-size: 10px; overflow: auto;" @selection-change="handleSelectionChange" :stripe="true" :highlight-current-row="true" class="e-border table-style" :default-sort = "{prop: 'noC', order: 'ascending'}">
        ...
        <el-table-column property="tauxTeletransmissions" v-if="actFilter === 's'" prop="iTt" sortable="custom" label="TAUX DE TÉLÉTRANSMISSION" show-overflow-tooltip width="180"><template slot-scope="scope"><el-progress :text-inside="true" :stroke-width="18" :percentage="formatTaux(scope.row.iTt)" color="#894cfa" ></el-progress></template></el-table-column>
