<template>
    <div id="glob-table" >
            <div class="table-wrapping">
              <el-table ref="multipleTable" :data="entreprises" style="width: 100%; font-size: 10px;"  :stripe="true" :highlight-current-row="true" :default-sort = "{prop: 'nom', order: 'ascending'}" class="e-border">
                ...
                <el-table-column property="name" label="ENTREPRISES" sortable min-width="120"><template scope="scope" ><div class="data-wrapper md-txt entHover pointer" >{{scope.row.noC}}</div></template></el-table-column>
